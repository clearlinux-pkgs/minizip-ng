...
Source0  : https://github.com/zlib-ng/minizip-ng/archive/4.0.9/minizip-ng-4.0.9.tar.gz
...
%prep
%setup -q -n minizip-ng-4.0.9
cd %{_builddir}/minizip-ng-4.0.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744041214
mkdir -p clr-build
pushd clr-build
